      ...
      <section className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="space-y-8">
          <div className="p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all">
            ...
            <p className="text-gray-300 leading-relaxed">{t('process.description')}</p>
          </div>
          <div className="p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all">
            <h2 className="text-2xl font-bold text-white mb-4">{t('includes.title')}</h2>
            <p className="text-gray-300 leading-relaxed">{t('includes.description')}</p>
          </div>
        </div>
